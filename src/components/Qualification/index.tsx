...
import { DETAILS, type qualification_type } from "../../Typography";
...
function Qualification({ primary, secondary, subTitle, title }: comptype) {
  return (
    <Box
      component="section"
      id="qualification"
